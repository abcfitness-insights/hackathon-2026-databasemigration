...
**Expected:** A long list of `PASSED` lines and at the bottom `169 passed in ~1-2s`. If you see 169 passed, the engine is healthy.
...
2. **The test suite passes** (10 sec)
   ...
   python -m pytest -v
   ```
   Just shows `169 passed` for credibility.
